...
<html>
    <head>
        ...
        <%
            String userName = (String) session.getAttribute("userNameErr"); //session starter; if incorrect print error
        %>

        <!-- header of the web page--> 
    <div id="textbox">   
        <h1 class="alignleft">Reservation Status</h1>
        <% if (userName != null) {%> 
...
<body>
    ...
    <h1>
        Thanks for using for our website.
